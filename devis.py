...
def nombre_pots(longueur, largeur, surface_couvrante):
    ...
    """
    return math.ceil(geometrie.aire(longueur,largeur)/surface_couvrante)
...
def nombre_rubans(longueur, largeur, perimetre_couvrante):
    ...
    post-conditions : Néant
    """
    return math.ceil(geometrie.perimetre(longueur,largeur)/perimetre_couvrante)
...
def salaire(longueur, largeur):
    ...
    post-conditions : Néant
    """
    return geometrie.aire(longueur,largeur) * 7.5
